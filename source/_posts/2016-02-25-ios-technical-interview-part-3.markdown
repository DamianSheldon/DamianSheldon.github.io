...
A: It depends on case, if we create app base on a UI framework, there is a autorelease pool already provided to us; otherwise, we should create one by ourself.
